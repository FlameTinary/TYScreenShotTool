...
enum AppText {
    ...
    static var settingsSubscriptionInfo: String { choose(
        zhHans: "订阅名称：AI Pro Monthly / 月度订阅\n订阅权益：AI 截图分析、高级 AI 功能等",
        en: "Subscription: AI Pro Monthly / Monthly Subscription\nBenefits: AI screenshot analysis, advanced AI features, and more",
        ja: "サブスクリプション名：AI Pro Monthly / 月額プラン\n特典：AI スクリーンショット分析、高度な AI 機能など",
        ko: "구독 이름: AI Pro Monthly / 월간 구독\n혜택: AI 스크린샷 분석, 고급 AI 기능 등",
        de: "Abonnement: AI Pro Monthly / Monatsabo\nVorteile: KI-Screenshotanalyse, erweiterte KI-Funktionen und mehr",
        fr: "Abonnement : AI Pro Monthly / abonnement mensuel\nAvantages : analyse IA des captures, fonctionnalités IA avancées, etc."
    ) }
